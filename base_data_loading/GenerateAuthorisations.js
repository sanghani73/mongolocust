...
async function load() {
    ...
    fileName = "Dataload-"+currentdate.toString()+".log"
    log("\nloading "+numberOfDocs+" in "+counter+" batches of "+BATCH_SIZE+" at "+currentdate.toString()+"\n")
    var before = new Date()
    ...
    log("Completed loading "+numberOfDocs+" in "+execution_mills+" (ms)")
await client.close();
}
