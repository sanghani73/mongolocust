...
if __name__ == '__main__':
    ...
    if (totalDocs <= numberOfProcesses):
        numberOfProcesses = totalDocs
    ...
    printStr = ("Launching " + str(numberOfProcesses) + 
                " processes to insert " +
                str(totalDocs) +
                " documents...\n")
    ...
    for i in range(numberOfProcesses):
        process = Process(target=run, args=(i, round(totalDocs / numberOfProcesses), filename))
        processesList.append(process)

    # launch processes
    start_processing_time = datetime.datetime.now()
    start_processing_message = (str(numberOfProcesses) +
    ...
    end_processing_message = (str(numberOfProcesses) + 
